...
import models.classifier_SWTFNet as classifier
...
def define_model(pretrained=False, model_root=None, encoder_model='Conv64F', classifier_model='DN4', norm='batch',
				 init_type='normal', use_gpu=True, **kwargs):
	model = None
	...
	elif classifier_model in ['ProtoNet', 'DN4']:
